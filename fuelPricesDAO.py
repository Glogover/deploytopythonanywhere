...
class FuelPricesDAO:
    ...
    def create(self, fuel_prices):
        ...
        values = (fuel_prices.get("station_id"), fuel_prices.get("petrol_95"), fuel_prices.get("diesel"), fuel_prices.get("lpg"), fuel_prices.get("price_date"))
        cursor.execute(sql, values)
    ...
    def update(self, id, fuel_prices):
        ...
        values = (fuel_prices.get("station_id"), fuel_prices.get("petrol_95"), fuel_prices.get("diesel"), fuel_prices.get("lpg"), fuel_prices.get("price_date"), id)
        cursor.execute(sql, values)
        self.connection.commit()
        self.closeAll()
